...
public class Constantes {
    ...
    public static final String URL_PESQUISA        = "https://swapi.dev/api/planets/?search=";
    public static final String NOT_FOUND_ID        = "Id de planeta não encontrado na base.";
